...
import com.afrozaar.jazzfestreporting.util.ImageCache;
import com.afrozaar.jazzfestreporting.util.ImageFetcher;
import com.afrozaar.jazzfestreporting.util.Upload;
import com.afrozaar.jazzfestreporting.util.Utils;
...
public class MainActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isCorrectlyConfigured()) {
           ...
           credential = GoogleAccountCredential.usingOAuth2(
            ...
            getFragmentManager().beginTransaction().replace(R.id.list_fragment,mUploadsListFragment,"UploadFragment").commit();
    ...
    private void showGoogleAccError() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);

        builder.setMessage("No Google Account was found on this device.\nPlease add an account and try again.")
