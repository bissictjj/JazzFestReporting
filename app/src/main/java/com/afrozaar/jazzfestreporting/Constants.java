...
public class Constants {
    ...
    public static final String DEFAULT_KEYWORD = "com.afrozaar.jazzfestreporting";
    ...
    public static final String UPLOAD_PLAYLIST = "PLEs-t2jgAm8KCPbXsu0cZB-2B4WJGRUTn";
    public static final String APP_NAME = "JazzFestReporting";
}
